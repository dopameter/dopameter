...
class TestSurface(unittest.TestCase):
    ...
    def test_rb(self):
        ...
        self.assertEqual(surface_metrics['counts']['letter_tokens'], 1599)
        ...
        self.assertEqual( round(surface_metrics['features']['ari'],2), 9)
        ...
        self.assertEqual( round(surface_metrics['features']['wiener_sachtextformel_1'],2), 5.27)
        self.assertEqual( round(surface_metrics['features']['wiener_sachtextformel_2'],2),  5.19)
        self.assertEqual( round(surface_metrics['features']['wiener_sachtextformel_3'],2), 5.2)
        self.assertEqual( round(surface_metrics['features']['wiener_sachtextformel_4'],2),5.26)
