...
from dopameter.delta.util import Metadata
from dopameter.delta.deltas import DistanceMatrix
from dopameter.delta.corpus import Corpus
...
class FlatClustering:
    ...
    def cluster_errors(self):
        ...
        return int((self.data.groupby("Cluster").agg(self.ngroups).Group-1).sum())
