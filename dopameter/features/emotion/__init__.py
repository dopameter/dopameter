...
class EmotionFeatures:
    ...
    * or in detail:
    ...
    def feat_corpus(self, corpus):
        ...
        if corpus.emotion['sum_emotions_words'] > 0:
            return {'features':{em: (corpus.emotion['features'][em] / corpus.emotion['sum_emotions_words']) for em in corpus.emotion['features']}}
        else:
            return {'features': {em: 0 for em in corpus.emotion['features']}}
